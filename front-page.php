...
<section class="hero">
  <div class="container">
    ...
    <p class="lead" data-aos="fade-up">A Scafeli é uma Produtora Audiovisual × Rio de Janeiro, São Paulo e Curitiba.</p>
...
<section class="about-home">
  ...
  <div class="row align-items-center">
    ...
    <div class="col-md-6">
      <img data-aos="fade" src="<?php bloginfo('template_url') ?>/img/supreme-scafeli.png" alt="">
    </div>
